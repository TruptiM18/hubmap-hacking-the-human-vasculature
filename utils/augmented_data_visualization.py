...
COCO_DATA_ROOT = "C:\\Users\\rushik\\Desktop\\AIForHealthcare\\hubmap_data\\augmented_data"
coco = COCO(COCO_DATA_ROOT + "\\" + "annotations.json")
...
for idx in range(0,5): #range(0,len(image_ids)):
    ...
    img = cv2.imread( f"{ COCO_DATA_ROOT + "\\data\\" + image['file_name']}")
